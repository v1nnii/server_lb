...
# Функция инкрементирования счетчика с синхронизацией
def increment_counter():
    global counter
    for _ in range(100000):
        with counter_lock:  # Защита счетчика с помощью блокировки
            local_counter = counter
            local_counter += 1
            counter = local_counter

# Функция декрементирования счетчика с синхронизацией
